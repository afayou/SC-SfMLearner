...
--name final-v2-resnet152_depth_256-train
...
--log-output --with-gt \
--pretrained-pose /home/meng72/mr/SC-SfMLearner-Release/checkpoints/resnet18_depth_256/exp_pose_model_best.pth.tar \
--name final-v2-resnet18_depth_256-train
...
--log-output --with-gt \
--pretrained-pose /home/meng72/mr/SC-SfMLearner-Release/checkpoints/resnet18_depth_256/exp_pose_model_best.pth.tar \
--name final-v2-resnet34_depth_256-train
...
--log-output --with-gt \
--pretrained-pose /home/meng72/mr/SC-SfMLearner-Release/checkpoints/resnet18_depth_256/exp_pose_model_best.pth.tar \
--name final-v2-resnet50_depth_256-train
...
--log-output --with-gt \
--pretrained-pose /home/meng72/mr/SC-SfMLearner-Release/checkpoints/resnet18_depth_256/exp_pose_model_best.pth.tar \
--name final-v2-resnet101_depth_256-train
