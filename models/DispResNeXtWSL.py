...
from .resnextwsl_encoder import *
...
class DispResNeXtWSL(nn.Module):

    def __init__(self, num_layers = 101, pretrained = True):
        super(DispResNeXtWSL, self).__init__()
        self.encoder = ResNeXtWSLEncoder(num_layers, pretrained = pretrained, num_input_images=1)
